...
│   └── 08-环境大升级方案.md        ← ✅ 已落地（代码完成，实机 L0–L5 待跑）：torch 2.8 / whisperx 3.8 / uv + 项目内环境
...
| 想清理 C 盘空间 / 删旧环境与模型缓存 | [`06-batch-and-tools/02-安装脚本与依赖.md`](06-batch-and-tools/02-安装脚本与依赖.md) 的 5.13 节 |
| 要装环境 / 换显卡 / 装不上依赖 | [`06-batch-and-tools/02-安装脚本与依赖.md`](06-batch-and-tools/02-安装脚本与依赖.md) |
| 想了解本次 torch 2.8 / whisperx 3.8 大升级改了什么 | [`05-guides/08-环境大升级方案.md`](05-guides/08-环境大升级方案.md) |
...
| [`08-环境大升级方案.md`](05-guides/08-环境大升级方案.md) | ~19K | ✅ **已落地**：torch 2.8 / whisperx 3.8 升级、显卡架构矩阵（cu126/cu128/cu129）、uv + 项目内环境、FFmpeg 大版本闸门、大文件下载分离、验证清单（L0–L5 待跑）与回滚 |
...
| [`02-安装脚本与依赖.md`](06-batch-and-tools/02-安装脚本与依赖.md) | ~56K | `Install.bat` 一键安装、`installer.py` 主流程、大文件下载分离（`_downloads/`）、FFmpeg 跳过策略、依赖逐行、三个启动 `.bat` |

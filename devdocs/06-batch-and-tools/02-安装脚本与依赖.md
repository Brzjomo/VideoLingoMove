...
3. 都没有才下载：`_pick_ffmpeg_asset` 按优先序列 `7.1 → 7.0 → 8.1 → 8.0` 选资产，
...
| FFmpeg 下载优先序列 | `FFMPEG_WIN_BRANCHES` = `("7.1", "7.0", "8.1", "8.0")` | 每个分支内优先 `-shared`，见 5.6 |
